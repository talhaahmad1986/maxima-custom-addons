...
class InvoiceStockMove(models.Model):
    ...
    def set_values(self,picking):
        picking.lpo = self.lpo
        picking.del_add = self.del_add
        picking.mark = self.mark
        picking.inv_ref = self.name
        self.do_ref = picking.name
